<template>
  <div>
    <div class="imageparent">
      ...
      <svg class="gear" viewBox="0 0 1077 1075">
        <image
          xlink:href="~/assets/gear.svg"
          width="1077"
          height="1075"
        ></image>
      </svg>
      <svg class="lion" viewBox="0 0 1158 1320">
        <image
          xlink:href="~/assets/lion.svg"
          width="1158"
          height="1320"
        ></image>
      </svg>
...
.lion {
  position: absolute;
  top: 50%;
  left: 90%; /* Updated to move the image to the right */
  width: 30%;
  height: auto;
